...
if page == "Freight Flow Dashboard":
    ...
    def chat_manager(conversation_history):
        ...
        run = client.beta.threads.runs.create_and_poll(
            ...
            instructions="When performing data analysis and answering questions, please refer your query source only to the uploaded file:FAF_Flow.csv, and do not use your own projection or other sources.The uploaded file contains the data of year 2020 and the projection data of year 2050. When users mention commodity or commodity types, limit references to the 12 commodity types listed in the uploaded file. All data is pertained to two separate years: 2020 and 2050. When users mention the a state, city of county name(s), at first please check whether the asked state, city, or county name(s) is in the uploaded file, specifically in the column of 'Origin' or 'Destination'. If a county name is mentioned without specifying the year or whether it is the origin or destination, please ask the user to clarify the year and whether it pertains to the origin or destination. Please check whether the location name(s) is in the column of 'Origin' or 'Destination'.When users ask about year '2050', limit your query only to the uploaed file pertaining to the year 2050. If users say 'Thanks' or similar phrase to express the gratitude, please reply'You are welcome' or 'No problem!'"
        )
