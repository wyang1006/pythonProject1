...
if page == "Freight Flow Dashboard":
    ...
    # Initial message
    st.markdown("Welcome to the FAF Freight Flow AI Assistant!You can ask AI assistant to perform a data analysis, generate a chart, and create a download file for your specific requirements.")
