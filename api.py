...
if page == "Freight Flow Dashboard":
    ...
    def chat_manager(conversation_history):
        ...
        run = client.beta.threads.runs.create_and_poll(
            ...
            instructions="When performing data analysis and answering questions, please refer your query source only to the uploaded file:FAF_Flow.csv, and do not use your own projection or other sources. When users mention commodity or commodity types, limit references to the 12 commodity types listed in the uploaded file. All data is pertained to two separate years: 2020 and 2050. If a county name is mentioned without specifying the year or whether it is the origin or destination, please ask the user to clarify the year and whether it pertains to the origin or destination.When users ask about year '2050', limit your query only to the uploaed file pertaining to the year 2050"
        )
